          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                //   height: 20,
                // ),
        for(var item in AllUserNewOrder )
                Card(
                  child: Padding(
             ...
             for(var product in item["AllProduct"])
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                       ...
                                       Container(width: 90, child:TextButton(onPressed: (){
                ...
                ScaffoldMessenger.of(context)
                  ...
                  ..showSnackBar(snackBar);
                         ...
                         }, child: Text("Cooking", style: TextStyle(color: Colors.white),), style: ButtonStyle(
              ...
              backgroundColor: MaterialStatePropertyAll<Color>(Colors.purple),
                ...
                ScaffoldMessenger.of(context)
                  ...
                  ..showSnackBar(snackBar);
                         ...
                         }, child: Text("Packaging", style: TextStyle(color: Colors.white),), style: ButtonStyle(
